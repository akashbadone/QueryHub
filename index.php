...
<p align="justify"><b>The QueryHub(QH)</b> is a discussion forum that gives information about various programming languages, general knowledge related questions, information related to Asp.net,Vb.net,Php,Os related questions ,etc. </p>
...
<!--                                 <p>
                                	<span class="art-button-wrapper">
                                		<span class="l"> </span>
                                		<span class="r"> </span>
                                		<a class="art-button" href="javascript:void(0)"></a>
                                	</span>
                                </p> -->
...
<tr><td><input name="submit" type="submit" value="login"><input type="reset" value="cancel"></td></tr>
                                ...
                                <div class="art-BlockHeader">
                                    ...
                                    <div class="art-BlockContent-body">
                                      <marquee direction="up" onmouseover="stop()" onmouseout="start()" scrollamount="1" scrolldelay="1" style="height:400px;">  <div>
                                                          <p><b>march 12 2017</b><br/>
                                                          In this form student/s can discuss any type of querry about 
														  project and technology which they are already using in
														  theirs respective project. 
														  <br/>
                                                          <a href="javascript:void(0)"></a></p>
                                                          
                                                          <p><b>14 march 2017</b><br/>
                                                         if anyone would find it helpful in their respective 
														 project contact us, we will be happy to help.<br/>
                                                          <a href="javascript:void(0)"></a></p>
                                                          </div>
		</marquee>
                                    </div>
